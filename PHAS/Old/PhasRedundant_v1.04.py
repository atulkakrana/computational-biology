...
res_folder = '24ALL'            ## Folder with all ther results
p_val = '1e-07'                 ## If specified a poor cutoff - it will include variants of loci with good cut-off
genome = 'MAIZE_AGPv2_genome'   ## Name for PHAS cluster naming
...
## "compare" module needs to be updated with changes made in 1.04 needs
