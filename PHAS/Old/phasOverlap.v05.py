...
featureFile     = "Trinity.fasta.gtf"                                                   ## Feature file in GTF format, with whome overlap needs to be checked
featureFile2    = "v3.genome.merged.gtf"                                                ## Second feature file if overlap needs to be checked with two lists, but independently
mode            = 4                                                         ## 1: PASA feature (GTF) file | 2: Trinity | 3: Rocket feature (GTF) file or generic gtf file with missing "transcript" entry | 4: Both rocket and trinity feature files | 5: PacBio GTF | 6: Comprehensive transciptome (from PASA) - NOTE: New mode should be registered in overlapchecker function

phasedFeature   = "Final_21PHAS_Loci_0.0005_ALL.rocket.trinity.FL.mod.csv"               ## [Optional, give an empty file] Phasredundant file of transcripts from feature file, to label overapping transcripts as true phased. Provide concataned file if both rocket and trinity GTF file used in mode3
