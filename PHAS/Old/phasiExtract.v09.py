...
clustfile       = 'female_pistil.score_p1e-05_sRNA_24_out.cluster'        ## Cluster file from phasing analysis, coul dbe for one lib or concatanated file for all libs
...
tagPosTable     = "ASPARAGUS_privPHAS_sRNA_TagPosSummReNorm"                ## if fetchMax == Y | Use this DB to get tag with max abundance


#### User specifed coords in input file
coordsfile      = "Final_PHAS_Loci_1e-05_ALL.csv"                   ## File with either phased loci ID 'Phas-100_w_7:6353898:6354260' or coords 'w,7,6353898,6354260'
...
## v08 -> v09 [stable] [last version to use tagposSummary]
