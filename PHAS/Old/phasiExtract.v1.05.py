...
clustfile       = "all.lib.txt.score_p0.0005_sRNA_24_out.rocket.cluster"  ## Cluster file from phasing analysis, coul dbe for one lib or concatanated file for all libs
...
def getClust(clustfile,phasList):
    ...
    for ent in phasList:                                                         ## Given an entry in coords file
        ...
        tempAllList.append((phasiCyc,phasiSig,phasID,clust_id)) ## This list has phasiRNAs from all cluters but to keep the structure same as original resList, helpful while writing results, this info is added
