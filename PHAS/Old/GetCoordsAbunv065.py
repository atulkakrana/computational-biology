...
coords = 'Final_PHAS_Loci_1e-07_24PHAS.csv'
...
## Small RNA lengths 
mode = 1                                                        ## 0: Get sRNA abundance for specific size and noise 1: Get sRNA abundance for comparision among sizes, sizes from both mainLen and noise Len used
