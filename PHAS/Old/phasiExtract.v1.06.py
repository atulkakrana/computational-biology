...
clustfile       = "all.txt.score_p1e-07_sRNA_21_out.cluster"        ## Cluster file from phasing analysis, coul dbe for one lib or concatanated file for all libs
...
sRNADB          = "SETARIA_privPHAS_sRNA"                           ## if fetchMax == Y | Use this DB to get tag with max abundance

#### User specifed coords in input file
coordsfile      = "Final_PHAS_Loci_1e-07_ALL.csv"                   ## File with either phased loci ID 'Phas-100_w_7:6353898:6354260' or coords 'w,7,6353898,6354260'
