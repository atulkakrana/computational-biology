...
mode = 1                        ## 0: Target coordinates match genome DB 1: transcripts or non-genome-DB targets
...
PAREres = '2118_2275_Rice_transALL_validated_miRUniq.csv' ## Mode = 0 revmapped file with 14th column as cleave site | Mode: 1 -local validation file with cleave site at column 9
...
def validatePHAS(resList,PHASdict,phase,con,header):
    ...
    for ent in resList: ##ent format: miRNA,Target,cleavesite,whole entry
        ...
        if mode == 0: ## targets coordinates match to genome DB i.e. server target analysis was done
            ...
            ##PHAS LOCI MATCH - Fuck you were not checking for cleave site in exact chromosme - Thats why you got shit load of results where these are scaffolds
...
## v04 -> v05
## Added functionality to vildate phased loci on local trasncripts rather genome