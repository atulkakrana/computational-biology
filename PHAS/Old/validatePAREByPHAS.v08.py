            ...
            for akey in PHASdict.keys():
                ...
                if cleaveSite in aval:
                        if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                            ...
                            matEnt = ('%s,%s,%s' % (ent[5],akey,(aval.index(cleaveSite)+1-6)))
                    ...
                    if offset == 1:
                        ...
                        if cleaveSite in aval1:
                            if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                                ...
                                matEnt = ('%s,%s,%s' % (ent[5],akey,(aval1.index(cleaveSite)+1-6)))
                            ...
                            if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                                ...
                                matEnt  = ('%s,%s,%s' % (ent[5],akey,(aval2.index(cleaveSite)+1-6)))
            ...
            for akey in PHASdict.keys():
                ...
                if cleaveSite1 in aval:
                        if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                            ...
                            matEnt = ('%s,%s,%s' % (ent[5],akey,(aval.index(cleaveSite1)+1-6)))
                        ...
                        if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                            ...
                            matEnt = ('%s,%s,%s' % (ent[5],akey,(aval.index(cleaveSite2)+1-6)))
                    ...
                    if offset == 1:
                        ...
                        if cleaveSite1 in aval1:
                            if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                                ...
                                matEnt  = ('%s,%s,%s' % (ent[5],akey,(aval1.index(cleaveSite1)+1-6)))
                            ...
                            if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                                ...
                                matEnt = ('%s,%s,%s' % (ent[5],akey,(aval1.index(cleaveSite2)+1-6)))
                            ...
                            if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                                ...
                                matEnt = ('%s,%s,%s' % (ent[5],akey,(aval2.index(cleaveSite1)+1-6)))
                            ...
                            if akey.split('-')[0] == chrid: ## i.e. clevage site is on same chromosme
                                ...
                                matEnt = ('%s,%s,%s' % (ent[5],akey,(aval2.index(cleaveSite2)+1-6)))
...
## Corrected 10 and 11th position computation in foro miRferno results
##
