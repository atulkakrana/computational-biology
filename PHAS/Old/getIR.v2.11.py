...
runMode     = 1                                             ## 0: Full run - find candidates, validate candidates 1: finalPairs file exists from earlier run now lib fetching, mapping, and plot files need to be generated 2: All earlier file exists, only consensusCands are new
fetchMap    = 0                                             ## Fetch libs and map to fasta file, madatory for runMode 0 
phase       = 24
fastaFile   = 'LA.24Phas.v2.fa'
blast_rc    = "Final_BLAST_RC.txt"
blast_nor   = "Final_BLAST_NOR.txt"
blast_comp  = "Final_BLAST_COMP.txt"
phasedRes   = "LA.Final_PHAS_Loci_5e-05_ALL-manualcuration.csv"
clustfile   = "all.txt.score_p5e-05_sRNA_24_out.cluster"    ## Cluster file from phasing analysis, coul dbe for one lib or concatanated file for all libs
...
consensusRes = 'Y'
consensusCands = "IR.cands.deepscan.list"
matchThres   = 0.25
