...
res_folder = '24PHAS'       ## Do not use './' or path here - will give error while making result file
p_val = '5e-07'             ## If specified a poor cutoff - it will include variants of loci with good cut-off
...
fileType = 'L'              ## L = *cluster.boundary.without.PARE.validation.list file, N = *NO.by.PARE.file, Y = *YES.by.PARE.file, if formatted CSV for intercomparision
                            ## C = Compare and combine csv files
    ...
    for afile in fls: ###
        ...
        ##Second and further Instance - Match the entries of new file with dictioary and add new one#############
            ...
            for ent in lines:
                ...
                mainkey_remade  = '%s-%s-%s' % (mainkey_decode[0],mainkey_decode[1],mainkey_decode[2])
                ...
                if maxratio <= 0.20: ### Treat as new loci and no need to delete any entry from existing values
                ...
                elif maxratio > 0.20: #### Choose the longest loci
