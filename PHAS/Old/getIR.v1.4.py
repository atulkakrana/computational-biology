...
runMode     = 2                                             ## 0: Full run - find candidates, validate candidates 1: finalPairs file exists from earlier run now lib fetching, mapping, and plot files need to be generated 3: All earlier file exists, only consensusCands are new
...
consensusRes = 'Y'
consensusCands = "IRcands.v1.list"
######## Developer settings ####################
...
def map2Dict(alib):
    ...
    for i in mapRead:
        ...
        if phasistrand == 'w' and phasilen > 20 and phasilen < 25: ## sRNAs of only positive strand used - OK
...
def main():
    if runMode == 0:
        ...
        chartInput,consensusInput = prepareChartFiles(validList,clustFile,userLibs,fastaFile)
...
## v1.2 -> v1.3b [major]
## Fixed sRNA parsed from map file positions by converting o-based offset to 1-based offset
