...
## This script uses the phasiRNA core script from SVN So, make sure your svn is updated
...
geno = 'Y' ### Run on whole genome (Y) or transcriptome file (N) - If (N) then provide index of transcriptome
geno_index = '/alldata/Genomic/Maize/UA/v2/BowtieGenomicIndexes/MAIZE_AGPv2_genome'
