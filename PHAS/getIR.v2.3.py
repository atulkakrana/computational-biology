...
runMode     = 0                                             ## 0: Full run - find candidates, validate candidates 1: finalPairs file exists from earlier run now lib fetching, mapping, and plot files need to be generated 2: All earlier file exists, only consensusCands are new
fetchMap    = 0                                             ## Fetch libs and map to fasta file, madatory for runMode 0 
phase       = 24
fastaFile   = 'foldback-LtoB.clean.fa'
blast_rc    = "Final_BLAST_RC.txt"
blast_nor   = "Final_BLAST_NOR.txt"
blast_comp  = "Final_BLAST_COMP.txt"
phasedRes   = "foldback-LtoB.v2.txt"
clustfile   = "all.txt.score_p1e-07_p5e-05_sRNA_24_out.cluster"    ## Cluster file from phasing analysis, coul dbe for one lib or concatanated file for all libs
...
consensusRes = 'Y'
consensusCands = "foldback-LtoB.final.list"
matchThres   = 0.25
libType      = 0                                                 ## 0: Lib_ids (4518) | 1: lib_code ('leaf_1')
excludeLibs  = [4518,5006,5003,5004,5005,4519,4521,4523,4525,4527,4520,4522,4524,4526,4528,5230,5231,5232,5235]   ##  Used if fetchMax == 'Y' | Libs you wish to exclude, your tag position summary table should have libs ids and not lib codes

######## Developer settings ####################
noiseAbun   = 1         ## 0: Used from the library file provided for mapping [default] | 1: fetched from server using libraries provided above i.e. same as phasiRNAs
