...
####### Settings #######################################
########################################################
mode = 0                                                        ## 0: Get sRNA abundance for specific size and noise 
...
tablename = 'RICE_sbsQIFA_sRNA_TagPosSummNorm'                  ## Tag position summary table required
genomeDB = 'RICE_MSU7'                                          ## Just to use for cluster name i.e that can be used directly on our website
coords = 'Final_PHAS_Loci_1e-07_21PHAS.csv'
excludeLibs = [2523,2524,2525,2526,2527,2528,4165,4166,4167,4168,4169]   ## If you wish to exclude a few libs then enter lib_id here, your tag position summary table shoul dhave libs ids and not lib codes
sep = '\t'                                                      ## Comma: ',' Tab: '\t'
header = 'Y'
## Input columns
...
## Small RNA lengths 
mainLen = [21,21]                                               ## Lengths of sRNAs to calculate abundance and used to compute ratio in mode 0
noiseLen = [19,20,22,23,24]                                  ## List of different sizes, used as noise to compute main to noise ratio in mode 0. In mode 1 both main and nois elist are combined and abundances reported
