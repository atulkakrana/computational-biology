...
requiredNamed.add_argument('-dir',  default='None', type=str, help='directory from your'\
...
def prepare(pcutoff,libs,res_folder):
   ...
   ### Get files for collapser #########################
    ...
    if acount == 0 or bcount == 0 :
        ...
        print("** Check if phaser analysis was run for different periodicity i.e. 21nt, 22nt or 24nt")
        sys.exit()
    else:
        pass
...
def writer_summ(clustfile,resList):
    '''
    write the results
    '''
    print("\n#### Fn:Writer_summ #################")
...
def main():
    ...
    results,results2 = writer_summ(clustfile,resList)
