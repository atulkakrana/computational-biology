...
## Updated: version-v0.99 01/01/17 
## Property of Meyers Lab at University of Delaware
## Author: Atul Kakrana kakrana@udel.edu

#### FUNCTIONS ###########################################

import os,sys,subprocess,multiprocessing,time,getpass,shutil,hashlib,datetime,collections,re
...
def dedup_writer(acounter,alib):
    ...
    countFile   = "%s.fas" % alib.rpartition('.')[0]
