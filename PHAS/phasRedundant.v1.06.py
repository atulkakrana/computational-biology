...
p_val           = '5e-05'           ## If specified a poor cutoff - it will include variants of loci with good cut-off
genome          = 'ASPARAGUS_UGA2'     ## Name for PHAS cluster naming
...
def RemoveRedundant(res_folder,p_val,fileType,overlapCutoff):
    """
...
def main():
    ...
    if fileType == 'L':
        ...
        main_dict = RemoveRedundant(res_folder,p_val,fileType,overlapCutoff)
    elif fileType == 'C':
        listConverter(res_folder,fileType)
