...
PAREdb = 'ASPARAGUS_sbsUGA1_PARE'        ## Make sure that your Library is in the DB 
...
miRNA_file = '22phasi.fa' ## If not present in directory than miRcode (below) will be sued to fetch miRNAs from miRbase table
...
extraAnno = 'Y'                         ## Fetched annotation from new tables - phased_loci and chr_inverted
