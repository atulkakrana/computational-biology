...
#libs = [3726,3727,3486,3519,3520,3521,3522,3523,3481,3482,3715,3716,3717,3718,3722,3723,3728,3733,3724,3725,3729,3734,3730,3735,3731,3736,3732,3737]
libs = [3225,3226,3227,3229,3228,3230]
reps = [1,1,2,2,3,3] ## for final step i.e. normalizing abundances
...
libType = 1 ## From cuffNorm manual 1) 0 = fr-unstranded 2) 1 = fr-firststrand 3) 2 = fr-secondstrand
...
def main(libs):
    ...
    #### 2. TRIM RAW files #############################################################
    rawInputs = [(i[0],i[1],i[2],i[3],i[4],i[5]) for i in register]
    if trimLibsStep == 1:
...
## Bring back th elocal version for publication
