...
mirna_file = 'arab_mirbase_all.fa' ### miRNA file in FASTA format
seq_file = 'genomic_seq.fa' ###cDNA/Transcript/Chromosome file in FASTA format
...
nproc = '28'###Number of processors to use
