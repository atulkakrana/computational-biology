...
######## SEETINGS ################
genomedb            = 'ASPARAGUS_UGA2_genome'     ## Genome DB to use for extraction
...
buff                = 150                             ## Length of static buffer
...
## v08 -> v09
## Fixed functionailty introduced in v08 in case of both strands required
