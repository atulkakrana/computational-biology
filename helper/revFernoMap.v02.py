...
predTar         = "inter_All.targs.parsed.aspa.v2.csv"
...
#### STEPS ######################
getCoords       = 1                             ## Get genomic coordinates from genomeDB, if OFF then "gene_coords" file in current folder will be used
