...
####### Settings #######################################
########################################################
mode = 2                                                        ## 0: Get sRNA abundance for specific size and noise 
...
tablename = 'BRACHY_pub_sRNA_v4TagPosSummNorm'                  ## Tag position summary table required
genomeDB = 'BRACHY_MIPS1'                                          ## Just to use for cluster name i.e that can be used directly on our website
coords = 'Final_PHAS_Loci_1e-07_24ALL.csv'
...
noiseLen = [18,19,21,20,22,23,24]                                  ## List of different sizes, used as noise to compute main to noise ratio in mode 0. In mode 1 both main and nois elist are combined and abundances reported
