...
####### Settings #######################################
########################################################
tablename = 'ASPARAGUS_privPHAS_sRNA_TagPosSummNorm'                  ## Tag position summary table required
genomeDB = 'ASPARAGUS_UGA1'                                          ## Just to use for cluster name i.e that can be used directly on our website
coords = 'RES_Asparagus_edited.fa_03_31_16_58_loop300.csv'
