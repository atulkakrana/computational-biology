...
SpecStrand = 'N' 						## Y: If strand is available and sequence needs to be from specific strand OR N: than you dont care about strand and want from both
...
startpos =  '8' 						## Column for start postion- excel format
endpos = '9' 							## Column for end position - excel format

## Buffer Settings
flankType = 1 							## 0:Static 1:Dynamic
buff = 24 								## Length of static buffer
buffRatio = 1							## Ratio of input sequence length to use for dynamic flanking seq from 5' and 3' 
