...
coords = 'RicePhasValid-NonRed-Uniq_miRNAFamily_Uniq.csv'
...
chrpos = '4' ##excel format
startpos =  '5' #### coordinate strat- excel format
endpos = '6' ## coordinate end - excel format
...
def Coords2Abun(con,coords,db):
    ...
    #lib_col = columns[8:]
    lib_col =",".join(str(x) for x in columns[8:])
    print(lib_col)
    ##Write file header
