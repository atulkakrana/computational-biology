...
## Run differential expression after rocket analysis ##
## Input files: abundances.cxb files in the *.cuffquant.out folders for each sample
## Input files: merged.gtf file generated by Rocket in the merged_asm folder
## Usage: cuffdiff [options] -L <labels for samples> <cufflink gtf file> <sample1_rep1,sample1_rep2 sample2_rep1,sample2_rep2 sampleN_rep1,sampleN_rep2>


cuffdiff -o cuffdiff_out --library-type fr-firststrand -L Asp05,Asp1,AspLeaf -p 42 ./merged_asm/merged.gtf ./Asp_0_5_ant_b.cuffquant.out/abundances.cxb,./Asp_0_5_ant_budr.cuffquant.out/abundances.cxb ./Asp_1_ant_b.cuffquant.out/abundances.cxb,./Asp_1_ant_budr.cuffquant.out/abundances.cxb ./Asp_leaf.cuffquant.out/abundances.cxb,./Asp_le.cuffquant.out/abundances.cxb 
