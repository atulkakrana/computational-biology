...
## this is python3 version of prepDE.py script
## the StringTie version at the time of it's download
## was 2.1.4; the dowmload link for this script: https://ccb.jhu.edu/software/stringtie/index.shtml?t=manual
## direct download link: https://ccb.jhu.edu/software/stringtie/dl/prepDE.py3
