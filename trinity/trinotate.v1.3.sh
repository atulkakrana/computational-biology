...
## Set Cores
cores=60
cd /home/kakrana/0.Atul/7.Assembl/3.aspa_trinity/SeqAssembly
...
## 2.A [mandatory] Load transcripts and coding regions ########
echo "###############################"
...
echo "###############################"
echo Loading SWISSPROT BLASTp results
echo "###############################"
echo Loading  blastP
...
echo "##############################"
echo Loading SWISSPROT blastx results
echo "##############################"
echo Loading blastx
Trinotate $sqlite_db LOAD_swissprot_blastx blastx.outfmt6

# ## [Optional] load transcript hits - If these files geenrated above
# echo "##############################"
# echo Loading UNIREF BLASTx/p results
# echo "##############################"
# ## load UNIREF protein hits
