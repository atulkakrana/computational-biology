...
GenomeDB = 'SOY_Gmax101_genome' ##DB to get fastaOut file
PAREdb = 'SOY_sbsUSB_PARE' ##Make sure that your Library is in the DB 
...
miRNA_file = 'miRCandidatesv02.csv.fa' ## If not present in directory than miRcode (below) will be sued to fetch miRNAs from miRbase table
miRCode = 'gma' ## Code of species to fetch miRNAs
ver = '21' ## mirbase version to use
miRTable = 'mirBASE' ## DO NOT TOUCH
...
libs =['709','2228','2229','2230','2231','2263','2264','2265','2267'] ## Name of PARE libraries (if getPARELib = 'N')
