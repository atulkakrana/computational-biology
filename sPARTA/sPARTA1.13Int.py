...
GenomeDB = 'MIMUL_JGI2_genome'      ## DB to get fastaOut file
PAREdb = 'MIMUL_sbsML_PARE'        ## Make sure that your Library is in the DB 
...
miRNA_file = 'Mimulus_miRNA_validated.fa' ## If not present in directory than miRcode (below) will be sued to fetch miRNAs from miRbase table
