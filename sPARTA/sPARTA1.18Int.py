...
## sPARTA-Int v1.18 - miRferno reached End of support -- Atul
...
GenomeDB            = 'ASPARAGUS_UGA2_genome'            ## DB to get fastaOut file
...
miRNA_file          = '24ntMirnas.fa'                           ## If not present in directory than miRcode (below) will be sued to fetch miRNAs from miRbase table
miRCode             = 'Asparagus'                             ## Code of species to fetch miRNAs. Not used if miRNA file is present in directory
