...
genomeFile = 'genomic_seq.fa'           ##From Phytozome - Not used if Local == N -- genes.attr_table_SecondAss_w_GTF.fa used in this analysis

miRNA_file = 'miRNA.fa' ## If not present in directory than miRcode (below) will be sued to fetch miRNAs from miRbase table
...
libs =['755','820','3098','3099','3100','4781','4782','4784','4785'] ## Name of PARE libraries - Mandatory
...
def resultUniq():
    ...
    if Local == 'Y':
        ...
        revamappedComb = './output/ALL_validated.csv'
