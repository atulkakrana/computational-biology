...
libs =['661_chopped.txt','91_chopped.txt','92_chopped.txt','94_chopped.txt'] ## Name of lib files
...
def validatedTargetsFinder(densityDict):
    ...
    for target in targetFinderList:
        ...
        if(gene in densityDict.keys()):
            ...
            if(location):
                ...
                # Append the p-value to the pValueList
    ...
    for i in range(len(correctedPValueList)):
        validatedTargets[i].append(str(correctedPValueList[i]))
